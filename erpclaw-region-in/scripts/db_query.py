...
def seed_india_defaults(conn, args):
    ...
    audit(conn, "erpclaw-region-in", "india-seed-india-defaults", "company", company_id,
...
def setup_gst(conn, args):
    ...
    audit(conn, "erpclaw-region-in", "india-setup-gst", "company", company_id,
...
def seed_indian_coa(conn, args):
    ...
    audit(conn, "erpclaw-region-in", "india-seed-indian-coa", "company", company_id,
...
def available_reports(conn, args):
    reports = [
        {"name": "GSTR-1", "action": "india-generate-gstr1", "description": "Outward supplies return (B2B + B2C)"},
        {"name": "GSTR-3B", "action": "india-generate-gstr3b", "description": "Monthly summary return"},
        {"name": "HSN Summary", "action": "india-generate-hsn-summary", "description": "HSN-wise outward supply summary"},
        {"name": "Input Tax Credit", "action": "india-compute-itc", "description": "ITC eligible vs ineligible"},
        {"name": "E-Invoice", "action": "india-generate-einvoice-payload", "description": "NIC v1.1 JSON for e-invoicing"},
        {"name": "E-Way Bill", "action": "india-generate-eway-bill-payload", "description": "E-way bill JSON for goods > INR 50K"},
        ...
        {"name": "Form 16", "action": "india-generate-form16", "description": "Annual TDS certificate for employees"},
        {"name": "Form 24Q", "action": "india-generate-form24q", "description": "Quarterly salary TDS return"},
...
ACTIONS = {
    # Validation (4)
    "india-validate-gstin": validate_gstin,
    "india-validate-pan": validate_pan,
    "india-validate-tan": validate_tan,
    "india-validate-aadhaar": validate_aadhaar,
    # GST (5)
    "india-compute-gst": compute_gst,
    "india-list-hsn-codes": list_hsn_codes,
    "india-add-hsn-code": add_hsn_code,
    "india-add-reverse-charge-rule": add_reverse_charge_rule,
    "india-compute-itc": compute_itc,
    # Seed (3)
    "india-seed-india-defaults": seed_india_defaults,
    "india-setup-gst": setup_gst,
    "india-seed-indian-coa": seed_indian_coa,
    # Reports (6)
    "india-generate-gstr1": generate_gstr1,
    "india-generate-gstr3b": generate_gstr3b,
    "india-generate-hsn-summary": generate_hsn_summary,
    "india-generate-einvoice-payload": generate_einvoice_payload,
    "india-generate-eway-bill-payload": generate_eway_bill_payload,
    "india-tax-summary": india_tax_summary,
    # TDS (2)
    "india-tds-withhold": tds_withhold,
    "india-generate-tds-return": generate_tds_return,
    # Payroll (8)
    "india-seed-india-payroll": seed_india_payroll,
    "india-compute-pf": compute_pf,
    "india-compute-esi": compute_esi,
    "india-compute-professional-tax": compute_professional_tax,
    "india-compute-tds-on-salary": compute_tds_on_salary,
    "india-generate-form16": generate_form16,
    "india-generate-form24q": generate_form24q,
    "india-payroll-summary": india_payroll_summary,
    # Status (2)
    "status": status_action,
    "india-available-reports": available_reports,
}

"""Shared pytest fixtures for ERPClaw Region CA unit tests."""
import os
import sys
...
import pytest
from ca_helpers import init_all_tables, get_conn, build_env
...
@pytest.fixture
def env(conn):
    """CA test environment: Canadian company + fiscal year."""
